...
[![GoDoc](https://godoc.org/github.com/ducminhnguyen/gleam/flow?status.svg)](https://godoc.org/github.com/ducminhnguyen/gleam/flow)
[![Wiki](https://img.shields.io/badge/docs-wiki-blue.svg)](https://github.com/ducminhnguyen/gleam/wiki)
[![Go Report Card](https://goreportcard.com/badge/github.com/ducminhnguyen/gleam)](https://goreportcard.com/report/github.com/ducminhnguyen/gleam)
...
# Documentation
* [Gleam Wiki](https://github.com/ducminhnguyen/gleam/wiki)
* [Installation](https://github.com/ducminhnguyen/gleam/wiki/Installation)
* [Gleam Flow API GoDoc](https://godoc.org/github.com/ducminhnguyen/gleam/flow)
...
https://github.com/ducminhnguyen/gleam/blob/master/examples/word_count_in_go/word_count_in_go.go
...
> go get github.com/ducminhnguyen/gleam/distributed/gleam
...
```go
  ...
  // 2. distributed mode
  import "github.com/ducminhnguyen/gleam/distributed"
  f.Run(distributed.Option())
...
* Fault tolerant [OnDisk()](https://godoc.org/github.com/ducminhnguyen/gleam/flow#Dataset.OnDisk).
* Read data from Local, HDFS, or S3.
* Data Sources
  * [Cassandra](https://github.com/ducminhnguyen/gleam/tree/master/plugins/cassandra), with [example](https://github.com/ducminhnguyen/gleam/tree/master/examples/cassandra_reader)
  * [Kafka](https://github.com/ducminhnguyen/gleam/tree/master/plugins/kafka) [example](https://github.com/ducminhnguyen/gleam/tree/master/examples/kafka_reader)
  * [Parquet files](https://github.com/ducminhnguyen/gleam/tree/master/plugins/file/parquet) [example](https://github.com/ducminhnguyen/gleam/tree/master/examples/parquet)
  * [ORC files](https://github.com/ducminhnguyen/gleam/tree/master/plugins/file/orc) [example](https://github.com/ducminhnguyen/gleam/tree/master/examples/orc)
  * [CSV files](https://github.com/ducminhnguyen/gleam/tree/master/plugins/file/csv) [example](https://github.com/ducminhnguyen/gleam/tree/master/examples/csv)
  * [TSV files](https://github.com/ducminhnguyen/gleam/tree/master/plugins/file/tsv)
  * [TXT files](https://github.com/ducminhnguyen/gleam/tree/master/plugins/file/txt)
  * Raw Socket [example]()

# Status
Gleam is just beginning. Here are a few todo items. Welcome any help!
* [Add new plugin to read external data](https://github.com/ducminhnguyen/gleam/wiki/Add-New-Source).
